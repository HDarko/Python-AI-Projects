...
# In[45]:
#Backgammon Match AI
#This Program simulates a Backgammon game between two AI agents using the MiniMax stategy
#along with two unique heuritics. 
#The names and symbols used by the agents can be entered by a user.
